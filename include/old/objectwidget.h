...
public:
	...
	QLabel* movableVal1Label;
	QLineEdit* movableVal1Input;
	QLabel* movableVal2Label;
	QLineEdit* movableVal2Input;
	QLabel* movableVal3Label;
	QLineEdit* movableVal3Input;

signals:
	void saveObjectSignal( ObjectInfo_t *, const char * );
