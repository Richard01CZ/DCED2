...
const short DATABLOCL_NOMATTER=0x0000;
...
#define SPECIAL_OBJECT_TYPE_VISOBJ						0x01	// 1
#define SPECIAL_OBJECT_TYPE_PLAYER						0x02	// 2
#define SPECIAL_OBJECT_TYPE_CAR							0x04	// 4
#define SPECIAL_OBJECT_TYPE_SCRIPT						0x05	// 5
#define SPECIAL_OBJECT_TYPE_DOOR						0x06	// 6
#define SPECIAL_OBJECT_TYPE_PUB_VEHICLE					0x08	// 8
#define SPECIAL_OBJECT_TYPE_TRAFFIC						0x0C	// 12
#define SPECIAL_OBJECT_TYPE_CHARACTER					0x1B	// 27
#define SPECIAL_OBJECT_TYPE_PEDS						0x12	// 18
#define SPECIAL_OBJECT_TYPE_SHOOTABLE					0x23	// 35
#define SPECIAL_OBJECT_TYPE_DOG							0x15	// 21
#define SPECIAL_OBJECT_TYPE_PLANE						0x16	// 22
#define SPECIAL_OBJECT_TYPE_RAIL_ROUTE					0x18	// 24
#define SPECIAL_OBJECT_TYPE_PUMPER						0x19	// 25
#define SPECIAL_OBJECT_TYPE_RACECAM						0x1C	// 28
#define SPECIAL_OBJECT_TYPE_WAGONS						0x1E	// 30
#define SPECIAL_OBJECT_TYPE_CLOCKS						0x22	// 34
#define SPECIAL_OBJECT_TYPE_TRUCKBACKSEAT				0x24	// 36

// Light Types
#define NORMAL_LIGHT_TYPE_POINT							0x01	// 1
#define NORMAL_LIGHT_TYPE_DIRECTIONAL					0x03	// 3
#define NORMAL_LIGHT_TYPE_AMBIENT						0x04	// 4
#define NORMAL_LIGHT_TYPE_FOG							0x05	// 5
#define NORMAL_LIGHT_TYPE_POINT_AMBIENT					0x06	// 6
#define NORMAL_LIGHT_TYPE_LAYERED_FOG					0x08	// 8
